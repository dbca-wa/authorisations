...
export default function Page() {
    return (
        <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <main className="bg-white p-8 rounded-lg shadow-lg w-full max-w-5xl">
                <h1 className="text-2xl font-bold mb-6 text-center">Animal Ethics Committee</h1>


                <form className="max-w-6xl mx-auto p-8 bg-white shadow-lg rounded-lg">
                    {/* Placeholder for Logo */}
                    <div className="text-center mb-8">
                        <div className="w-32 h-32 bg-gray-200 mx-auto rounded-full"></div>
                    </div>
