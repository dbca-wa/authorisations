...
/**
 * Displays the S717 collection notice content for application consent flow.
 *
...
/**
 * Wraps the collection notice disclaimer with dialog-specific acknowledgement controls.
 *
 ...
 */
const CollectionNoticeConsentDialogContent = ({
    onAgree,
    onDecline,
}: {
...
const startApplication = async ({
    ...
    /**
     * Opens the collection notice consent window and gates application creation on acceptance.
     */
    const showCollectionNoticeConsentDialog = () => {
        showDialog({
            title: "Collection Notice Disclaimer",
            content: (
                <CollectionNoticeConsentDialogContent
                    onDecline={() => {
                        hideDialog();
                        setInProgress(false);
                    }}
            ...
            actions: (
                <>
                    ...
                    <Button
                        ...
                        onClick={async () => {
                            hideDialog();
                            showCollectionNoticeConsentDialog();
                        }}
                    >Confirm</Button>
                </>
            ),
